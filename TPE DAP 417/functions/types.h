...
// 1) Structure pour représenter une plage horaire
typedef struct {
...
// 2) Structure pour représenter un cours
typedef struct {
...
// 3) Structure pour représenter une séance
typedef struct {
...
// 4) Structure pour l'emploi du temps (tableau dynamique de séances)
typedef struct {
